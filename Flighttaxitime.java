...
class FlighttaxitimeMapper extends Mapper<Object, Text, Text, DoubleWritable>{
	...
	public class Flighttaxitime {
		...
		public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException{
			...
			Job conf=Job.getInstance(new Configuration(),"Flighttaxitime");
			conf.setJarByClass(Flighttaxitime.class);
			conf.setMapperClass(FlighttaxitimeMapper.class);
			conf.setReducerClass(FlighttaxitimeReducer.class);
